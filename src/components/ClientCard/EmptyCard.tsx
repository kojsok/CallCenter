...
const EmptyCard = () => {
  return (
    <Box className="h-full flex flex-col justify-normal	 items-center gap-8 rounded-2xl xs:border-2 xs:border-primary-light xs:p-4 lg:rounded-none lg:border-transparent lg:p-0">
